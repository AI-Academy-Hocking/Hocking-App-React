...
const handbookSections: HandbookSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Hawks Center for Well-Being (JL) – Do you need an immunization, physical or other form of basic medical care? Call the Wellness Center at <a href=\"tel:7407537079\" className=\"text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 underline\">740-753-7079</a> or stop in to John Light 241.",
  ...
  },
  {
    ...
    content: [
      ...
      "Students wishing to purchase supplemental internet packages can do so by contacting Nelsonville TV Cable (<a href=\"tel:7407532686\" className=\"text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 underline\">740-753-2686</a>).",
  ...
  },
  {
    ...
    content: [
      ...
      "Summit and Sycamore Hall students can make requests via e-mail to <a href=\"mailto:workorder@lhxprop.com\" className=\"text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 underline\">workorder@lhxprop.com</a>.",
