...
export default function CampusHealth() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      ...
      {/* Quick Stats */}
      <Card className="mb-8 border-2 border-red-600 dark:border-red-400 rounded-2xl overflow-hidden">
      ...
      <Accordion type="single" collapsible className="space-y-6">
        ...
        <AccordionItem value="medical" className="border-2 border-blue-600 dark:border-blue-400 rounded-2xl overflow-hidden mb-6">
          <AccordionTrigger hideChevron={true} className="bg-white dark:bg-gray-800 px-6 py-8 min-h-[100px]">
            <div className="flex items-center justify-start w-full">
              ...
              <span className="text-xl font-semibold text-blue-600 dark:text-blue-400">Medical Care – Hawks Center for Well‑Being</span>
            </div>
          </AccordionTrigger>
        ...
        <AccordionItem value="mental" className="border-2 border-green-600 dark:border-green-400 rounded-2xl overflow-hidden mb-6">
          <AccordionTrigger hideChevron={true} className="bg-white dark:bg-gray-800 px-6 py-8 min-h-[100px]">
            <div className="flex items-center justify-start w-full">
              <Brain className="mr-3 h-6 w-6 text-green-600" />
              <span className="text-xl font-semibold text-green-600 dark:text-green-400">Mental Health & Counseling Services</span>
            </div>
          </AccordionTrigger>
          <AccordionContent className="px-6 py-8 bg-white dark:bg-gray-900">
            <div className="space-y-6">
        ...
        <AccordionItem value="emergency" className="border-2 border-orange-600 dark:border-orange-400 rounded-2xl overflow-hidden mb-6">
          <AccordionTrigger hideChevron={true} className="bg-white dark:bg-gray-800 px-6 py-8 min-h-[100px]">
            <div className="flex items-center justify-start w-full">
              <AlertTriangle className="mr-3 h-6 w-6 text-orange-600" />
              <span className="text-xl font-semibold text-orange-600 dark:text-orange-400">Emergency & Crisis Services</span>
            </div>
          </AccordionTrigger>
          <AccordionContent className="px-6 py-8 bg-white dark:bg-gray-900">
            <div className="space-y-6">
        ...
        {/* Wellness Resources */}
        <AccordionItem value="wellness" className="border-2 border-purple-600 dark:border-purple-400 rounded-2xl overflow-hidden mb-6">
          <AccordionTrigger hideChevron={true} className="bg-white dark:bg-gray-800 px-6 py-8 min-h-[100px]">
            <div className="flex items-center justify-start w-full">
              <BookOpen className="mr-3 h-6 w-6 text-purple-600" />
              <span className="text-xl font-semibold text-purple-600 dark:text-purple-400">Wellness Resources & Education</span>
            </div>
          </AccordionTrigger>
          <AccordionContent className="px-6 py-8 bg-white dark:bg-gray-900">
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 bg-white dark:bg-gray-800 rounded-xl border-2 border-purple-600 dark:border-purple-400">
                  <h4 className="font-semibold text-purple-600 dark:text-purple-400 mb-4">Health Education</h4>
                ...
                <div className="p-6 bg-white dark:bg-gray-800 rounded-xl border-2 border-purple-600 dark:border-purple-400">
                  <h4 className="font-semibold text-purple-600 dark:text-purple-400 mb-4">Wellness Programs</h4>
                  <div className="space-y-3 text-purple-700 dark:text-purple-300">
              ...
              <div className="p-6 bg-white dark:bg-gray-800 rounded-xl border-2 border-purple-600 dark:border-purple-400">
                <h4 className="font-semibold text-purple-600 dark:text-purple-400 mb-4">Online Resources</h4>
                <div className="grid md:grid-cols-2 gap-6">
                  <button
        ...
        <AccordionItem value="contact" className="border-2 border-gray-600 dark:border-gray-400 rounded-2xl overflow-hidden">
          ...
          <AccordionContent className="px-6 py-8 bg-white dark:bg-gray-900">
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl border-2 border-gray-600 dark:border-gray-400">
                  <h4 className="font-semibold text-gray-600 dark:text-gray-400 mb-4">General Inquiries</h4>
                  <div className="space-y-3">
                    <div className="flex items-center justify-start w-full">
                ...
                <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl border-2 border-gray-600 dark:border-gray-400">
                  <h4 className="font-semibold text-gray-600 dark:text-gray-400 mb-4">Hours of Operation</h4>
              ...
              <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl border-2 border-gray-600 dark:border-gray-400">
                <h4 className="font-semibold text-gray-600 dark:text-gray-400 mb-4">Important Notes</h4>
                <div className="space-y-3 text-gray-700 dark:text-gray-300">
