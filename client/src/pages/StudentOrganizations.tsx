  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      ...
      <Accordion type="single" collapsible className="mb-8">
        ...
        <AccordionItem value="organizations" className="border-2 border-blue-600 rounded-2xl mb-4">
          ...
          <AccordionContent className="px-6 pb-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-4 bg-white dark:bg-gray-800 border-2 border-blue-600 rounded-2xl transition-colors">
              ...
              <div className="p-4 bg-white dark:bg-gray-800 border-2 border-green-600 rounded-2xl transition-colors">
                <div className="flex items-center gap-3 mb-3">
              ...
              <div className="p-4 bg-white dark:bg-gray-800 border-2 border-purple-600 rounded-2xl transition-colors">
                <div className="flex items-center gap-3 mb-3">
        ...
        <AccordionItem value="start-organization" className="border-2 border-teal-600 rounded-2xl mb-4">
          <AccordionTrigger className="bg-white dark:bg-gray-800 px-6 py-4 hover:no-underline min-h-[80px] flex items-center rounded-t-2xl data-[state=closed]:rounded-b-2xl [&>svg]:hidden">
        ...
        {/* Benefits of Joining */}
        <AccordionItem value="benefits" className="border-2 border-indigo-600 rounded-2xl mb-4">
          <AccordionTrigger className="bg-white dark:bg-gray-800 px-6 py-4 hover:no-underline min-h-[80px] flex items-center rounded-t-2xl data-[state=closed]:rounded-b-2xl [&>svg]:hidden">
          ...
          <AccordionContent className="px-6 pb-6">
            <div className="grid md:grid-cols-3 gap-4">
              <div className="p-4 bg-white dark:bg-gray-800 border-2 border-indigo-600 rounded-2xl transition-colors">
        ...
        <AccordionItem value="faq" className="border-2 border-gray-600 rounded-2xl mb-4">
          ...
          <AccordionContent className="px-6 pb-6">
            <Accordion type="single" collapsible className="w-full space-y-3">
              <AccordionItem value="join-organization" className="border-2 border-gray-600 rounded-2xl bg-white dark:bg-gray-800">
              ...
              <AccordionItem value="start-organization" className="border-2 border-gray-600 rounded-2xl bg-white dark:bg-gray-800">
                <AccordionTrigger className="text-left px-4 py-3 rounded-t-2xl data-[state=closed]:rounded-b-2xl [&>svg]:hidden">
              ...
              <AccordionItem value="meeting-times" className="border-2 border-gray-600 rounded-2xl bg-white dark:bg-gray-800">
                <AccordionTrigger className="text-left px-4 py-3 rounded-t-2xl data-[state=closed]:rounded-b-2xl [&>svg]:hidden">
              ...
              <AccordionItem value="costs" className="border-2 border-gray-600 rounded-2xl bg-white dark:bg-gray-800">
                <AccordionTrigger className="text-left px-4 py-3 rounded-t-2xl data-[state=closed]:rounded-b-2xl [&>svg]:hidden">
              ...
              <AccordionItem value="time-commitment" className="border-2 border-gray-600 rounded-2xl bg-white dark:bg-gray-800">
                <AccordionTrigger className="text-left px-4 py-3 rounded-t-2xl data-[state=closed]:rounded-b-2xl [&>svg]:hidden">
