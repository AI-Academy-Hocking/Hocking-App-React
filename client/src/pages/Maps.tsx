...
export default function Maps() {
  ...
  const staticAcademicBuildings: Building[] = [
    ...
    { id: 'logan-campus-energy-institute', name: 'Logan Campus/Energy Institute', description: 'Logan Campus Energy Institute', category: 'academic', lat: 39.55836635228117, lng: -82.45812838388986 },
  ];
