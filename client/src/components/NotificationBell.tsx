...
export default function NotificationBell() {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-12 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50" style={{ left: '6px', right: '2px' }}>
          <Card>
